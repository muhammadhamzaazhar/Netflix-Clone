const requests = {
    fetchTrending: `/trending/all/week?api_key=${import.meta.env.VITE_API_KEY}&language=en-US`,
    fetchNetflixOriginals: `/discover/tv?api_key=${import.meta.env.VITE_API_KEY}&with_networks=123`,
    fetchTopRated: `/movie/top_rated?api_key=${import.meta.env.VITE_API_KEY}&language=en-US`,
